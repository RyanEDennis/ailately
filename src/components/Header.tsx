    ...
    <>
      ...
      <header className="mx-auto w-full max-w-[1180px] px-5 sm:px-8">
        <div className="masthead">
          ...
          <div className="relative z-[1] flex flex-col items-center gap-2 pt-4 pb-6 text-center">
            <Link href="/" className="wordmark wordmark--grad text-[2.6rem] leading-none sm:text-[3.4rem]" aria-label={`${SITE.name} home`}>
              AI Lately
            </Link>
            <p className="meta italic text-[0.95rem] text-ink-soft" style={{ fontFamily: "var(--font-serif)" }}>
              {SITE.tagline}
            </p>
          </div>
        </div>
        <div className="gradbar" aria-hidden="true" />
